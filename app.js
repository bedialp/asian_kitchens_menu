...
//All butonu oluşturuldu;

let allBtn = document.createElement("button");
allBtn.classList.add('btn-item')
allBtn.innerText = "All"
btnCon.appendChild(allBtn);
allBtn.addEventListener("click", () => showMenu(menu));



//category butonları oluşturuldu;

//kategori item'larını içeren array'ler oluşturuldu;
